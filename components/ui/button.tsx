 ...
 * 
 * Defines the available visual variants and sizes for the Button component:
 * Variants:
...
export interface ButtonProps
  ...
  /** Flag to use a custom element via Radix Slot */
  asChild?: boolean
}
 ...
 * Button component
 * 
 * A versatile button component with multiple styling options.
 * 
 * @param props - Button component props including variant, size, and HTML button attributes
